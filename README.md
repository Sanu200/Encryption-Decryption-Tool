...
# Donations
When I was actively developing THEncrpterX, I accepted donations, but now that THEncrpterX is complete and production-ready, there's no need anymore. Instead, take your time and effort to share the love of THEncrpterX with others. Donations are nice, but being able to help others is a lot more valuable to me than a few spare dollars. Knowing that THEncrpterX is helping people secure their files is plenty enough for me.
